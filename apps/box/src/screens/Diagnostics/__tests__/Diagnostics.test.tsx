...
describe('i18n strings present', () => {
    ...
    const referencedKeys = [
        ...
        // Raw Diagnostics card (wired) — rawDiag.* + remoteSupport.*
        'diagnostics.rawDiag.intro',
        'diagnostics.rawDiag.fetch',
        'diagnostics.rawDiag.refetch',
        'diagnostics.rawDiag.fetching',
        'diagnostics.rawDiag.fetchingHint',
        'diagnostics.rawDiag.viaLan',
        'diagnostics.rawDiag.viaBle',
        'diagnostics.rawDiag.viaNone',
        'diagnostics.rawDiag.bloxUnreachable',
        'diagnostics.rawDiag.previewIntro',
        'diagnostics.rawDiag.sending',
        'diagnostics.rawDiag.sent',
        'diagnostics.rawDiag.send',
        'diagnostics.rawDiag.sentConfirmation',
        'diagnostics.rawDiag.sendFailed',
        'diagnostics.remoteSupport.title',
        'diagnostics.remoteSupport.explanation',
        'diagnostics.remoteSupport.securityCodePrompt',
        'diagnostics.remoteSupport.cancel',
        'diagnostics.remoteSupport.confirm',
        'diagnostics.remoteSupport.enabling',
        'diagnostics.remoteSupport.success',
        'diagnostics.remoteSupport.failed',
        'diagnostics.remoteSupport.badCode',
        'diagnostics.remoteSupport.noCodeFile',
        'diagnostics.remoteSupport.headerRejected',
        'diagnostics.remoteSupport.notInstalled',
        'diagnostics.remoteSupport.tunnelInactive',
        'diagnostics.remoteSupport.lanOnly',
        'diagnostics.remoteSupport.sectionHint',
        'diagnostics.remoteSupport.openButton',
    ];
