  ...
  return (
    <FxSafeAreaBox flex={1} paddingHorizontal="20" paddingVertical="16">
      ...
      <FxBox flex={1} justifyContent="space-between" paddingVertical="80">
        ...
        <FxText>
          App needs notification permission to connect your wallet and perform
          data sync. Tap allow in the next prompt.
        </FxText>
        <FxButton size="large" onPress={allowNotifications}>
          Allow Notifications
        </FxButton>
      </FxBox>
    </FxSafeAreaBox>
